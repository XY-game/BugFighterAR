...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_ABaseGameLogicActor_InitHero()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_location = { UE4CodeGen_Private::EPropertyClass::Struct, "location", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(BaseGameLogicActor_eventInitHero_Parms, location), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_location,
			};
#if WITH_METADATA
	...
	UClass* Z_Construct_UClass_ABaseGameLogicActor()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_ABaseGameLogicActor_InitHero, "InitHero" }, // 4091036192
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_PlayerAction = { UE4CodeGen_Private::EPropertyClass::Object, "PlayerAction", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(ABaseGameLogicActor, PlayerAction), Z_Construct_UClass_ABasePlayerActionActor_NoRegister, METADATA_PARAMS(NewProp_PlayerAction_MetaData, ARRAY_COUNT(NewProp_PlayerAction_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ABaseGameLogicActor, 3816495567);
