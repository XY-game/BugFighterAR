...
// Cross Module References
	...
	ROBOTBURST_API UFunction* Z_Construct_UFunction_AACTPlayerActionActor_AttackButtonClick();
...
// End Cross Module References
	void AACTPlayerActionActor::StaticRegisterNativesAACTPlayerActionActor()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "AttackButtonClick", (Native)&AACTPlayerActionActor::execAttackButtonClick },
			{ "JoystickMove", (Native)&AACTPlayerActionActor::execJoystickMove },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	UFunction* Z_Construct_UFunction_AACTPlayerActionActor_AttackButtonClick()
	{
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_AACTPlayerActionActor, "AttackButtonClick", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
	...
	UClass* Z_Construct_UClass_AACTPlayerActionActor()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_AACTPlayerActionActor_AttackButtonClick, "AttackButtonClick" }, // 174351579
	...
	IMPLEMENT_CLASS(AACTPlayerActionActor, 2894813283);
