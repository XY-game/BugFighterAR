...
#define RobotBurst_Source_RobotBurst_GameLogic_GameAssetManagerActor_h_12_RPC_WRAPPERS \
 \
	DECLARE_FUNCTION(execEmptyBPAssetMap) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->EmptyBPAssetMap(); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execRemoveBPAssetMap) \
	{ \
		P_GET_PROPERTY(UStrProperty,Z_Param_AssetPath); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->RemoveBPAssetMap(Z_Param_AssetPath); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execLoadBPAssetMap) \
	{ \
		P_GET_PROPERTY(UStrProperty,Z_Param_AssetPath); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UObject**)Z_Param__Result=this->LoadBPAssetMap(Z_Param_AssetPath); \
		P_NATIVE_END; \
	} \
 \
