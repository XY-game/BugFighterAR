...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_ASingleGameLogicActor_InitHero()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Location = { UE4CodeGen_Private::EPropertyClass::Struct, "Location", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(SingleGameLogicActor_eventInitHero_Parms, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Location,
			};
#if WITH_METADATA
	...
	UFunction* Z_Construct_UFunction_ASingleGameLogicActor_InitNavMesh()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Location = { UE4CodeGen_Private::EPropertyClass::Struct, "Location", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(SingleGameLogicActor_eventInitNavMesh_Parms, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Location,
			};
#if WITH_METADATA
	...
	UClass* Z_Construct_UClass_ASingleGameLogicActor()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_ASingleGameLogicActor_InitHero, "InitHero" }, // 4112122048
				{ &Z_Construct_UFunction_ASingleGameLogicActor_InitLogic, "InitLogic" }, // 1843332909
				{ &Z_Construct_UFunction_ASingleGameLogicActor_InitNavMesh, "InitNavMesh" }, // 1865556815
	...
	IMPLEMENT_CLASS(ASingleGameLogicActor, 2471323298);
