...
static struct FScriptStruct_RobotBurst_StaticRegisterNativesFHeroTableRow
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FHeroTableRow()
	{
		...
		if (!ReturnStruct)
		{
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AttackComboRowName_MetaData[] = {
				{ "Category", "Hero" },
				{ "ModuleRelativePath", "Data/FHeroTableRow.h" },
			};
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_AttackComboRowName = { UE4CodeGen_Private::EPropertyClass::Name, "AttackComboRowName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FHeroTableRow, AttackComboRowName), METADATA_PARAMS(NewProp_AttackComboRowName_MetaData, ARRAY_COUNT(NewProp_AttackComboRowName_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AttackAnimRowName_MetaData[] = {
				{ "Category", "Hero" },
				{ "ModuleRelativePath", "Data/FHeroTableRow.h" },
			};
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_AttackAnimRowName = { UE4CodeGen_Private::EPropertyClass::Name, "AttackAnimRowName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FHeroTableRow, AttackAnimRowName), METADATA_PARAMS(NewProp_AttackAnimRowName_MetaData, ARRAY_COUNT(NewProp_AttackAnimRowName_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_AttackComboRowName,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_AttackAnimRowName,
	...
	uint32 Get_Z_Construct_UScriptStruct_FHeroTableRow_CRC() { return 323140913U; }
